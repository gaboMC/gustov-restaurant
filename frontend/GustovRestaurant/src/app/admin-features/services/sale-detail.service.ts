...
import { SaleDetailInterface, SaleDetailReportInterface } from "../models";
...
export class SaleDetailService{
  ...
  getAll$(filterDtate: string)
  {
    return this.#httpClient.get<ApiResponseInterface<Array<SaleDetailReportInterface>>>(`${this.#endPoint}first-report?filterDate=${filterDtate}`);
  }
}
